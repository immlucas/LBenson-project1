const feedAllItem = require('../model/feedItems'); 
//creating function feedItem
...
//creating array
var currentStories = [];
//creating all values inside of array and pushing
...
//sends current stories to application/json
exports.getFeedItem = function(req, res) {
    res.setHeader('Content-Type', 'application/json');
    res.send(currentStories);
};

//creates a updated feed and sends it to application/json
...
//sends a single feed item to application/json
exports.getSingleFeedItem = function(req, res) {
    res.setHeader('Content-Type', 'application/json');
    res.send(currentStories[req.params.feedItemId]);
};
//removes a feedItem from the array and sends the product to application/json
exports.deleteFeedItem = function(req, res) {
    currentStories.splice(req.params.feedItemId, 1);
    res.setHeader('Content-Type', 'application/json');
    res.send(currentStories);
};
//updates feed's items and sends it to application/json
